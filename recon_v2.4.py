...
python recon_v2.4.py -D -Q 0 1 inf -b error_bar_parameters.txt -o
...
python recon_v2.4.py -p -q 0 -o test_power_table.txt error_bar_parameters.txt
...
python recon_v2.4.py -r -o test_sample_1_resample.txt
...
python recon_v2.4.py -x --x_max 30 -o test_sample_1_plotfile.txt -b error_bar_parameters.txt test_sample_1_fitfile.txt
...
def read_observed_clone_size_distribution_v2(file_in, clone_distribution_in_file, threshold):
    ...
    with open(file_in,'rU') as f:
        ...
        if clone_distribution_in_file: # Format from literature
            ...
            observed_clone_size_distribution = Counter(species_count_hash.values())
