...
def output_table_of_D_numbers(precomputed_error_bar_file, D_number_output_filename, list_of_filenames, qs="0.,1.,2.,inf"):
    ...
    obsinfD = {}
    """
    obs_qDs = defaultdict(lambda: defaultdict(list))
    #
    ...
    for data_filename in list_of_filenames:
        ...
        try:
            ...
            # if data_filename doesn't list a threshold for some reason, assert it as 30
            print "WARNING: no threshold in %s; assuming observed_threshold = 30" % data_filename
            ...
            #
            """
            for key in obs_qDs.keys():  # debug
                print key, obs_qDs[key] # debug
            exit()                     # debug
